            ...
            <tbody>
                @forelse ($notes as $note)
                    <tr>
                        ...
                        <td class="border p-2">{{ $note->etudiant->prenom }} {{ $note->etudiant->nom }}</td>
                        <td class="border p-2">{{ $note->matiere->nom }}</td>
                        ...
                        <td class="border p-2">
                            ...
                            <form action="{{ route('enseignant.notes.destroy', $note->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="6" class="border p-2 text-center">Aucune note trouvée.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
